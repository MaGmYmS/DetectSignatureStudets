...
def main():
    ...
    model.train_my_model(model_size="s", number_epoch=100, image_size=1280)
    ...
    # detect_model.create_dataset_with_signature(visualise=True)
    # image_path = r"data 2\Test10_iteration_1.jpg"
